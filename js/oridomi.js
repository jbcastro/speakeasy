...
(function() {
  ...
  getGradient = function(anchor) {
    return (
      ...
      "(" +
      anchor +
      ", rgba(0, 0, 0, .5) 0%, rgba(255, 255, 255, .35) 100%)"
    );
  };
  ...
  prep = function(fn) {
    return function() {
      ...
      if (this._touchStarted) {
        ...
        this._queue.push([
          fn,
          this._normalizeAngle(angle),
          this._getLonghandAnchor(anchor),
          opt
        ]);
        this._step();
        return this;
  ...
  (function() {
    ...
    (ref1 = (function() {
      ...
      for (j = 0, len1 = prefixList.length; j < len1; j++) {
        prefix = prefixList[j];
        plainGrab = "grab";
        testEl.style.cursor = grabValue =
          "-" + prefix.toLowerCase() + "-" + plainGrab;
      ...
      (css.grab = ref1[0]),
      (css.grabbing = ref1[1]);
    css.transformProp = (prefix = css.transform.match(/(\w+)Transform/i))
  ...
  OriDomi = (function() {
    function OriDomi(el1, options) {
      ...
      for (j = 0, len1 = anchorList.length; j < len1; j++) {
        anchor = anchorList[j];
        this._panels[anchor] = [];
        this._stages[anchor] = cloneEl(
          stageProto,
          false,
          "stage" + capitalize(anchor)
        );
        if (this._shading) {
          ...
          shaderProtos[anchor] = cloneEl(
            shaderProto,
            false,
            "shader" + capitalize(anchor)
          );
        }
      }
      ...
      for (o = 0, len4 = ref1.length; o < len4; o++) {
        ...
        panelConfig = this._config[
          (panelKey = classSuffix.toLowerCase() + "Panels")
        ];
        if (typeof panelConfig === "number") {
          ...
          if (
            !(
              99 <=
                (ref2 = panelConfig.reduce(function(p, c) {
                  return p + c;
                })) && ref2 <= 100.1
            )
          ) {
        ...
        for (
          rightOrBottom = r = 0, len6 = anchorSet.length;
          r < len6;
          rightOrBottom = ++r
        ) {
          anchor = anchorSet[rightOrBottom];
          for (
            panelN = t = 0, ref3 = count;
            0 <= ref3 ? t < ref3 : t > ref3;
            panelN = 0 <= ref3 ? ++t : --t
          ) {
              ...
              if (panelN === 0) {
                ...
                offsets[anchor].push(
                  (offsets[anchor][prev] - 100) *
                    (panelConfig[prev] / panelConfig[index])
                );
              }
            }
            if (panelN === 0) {
              ...
              panel.style[metric] =
                (panelConfig[index] / panelConfig[prev]) * 100 + "%";
            }
            if (this._shading) {
              for (i = u = 0, len7 = anchorSet.length; u < len7; i = ++u) {
                a = anchorSet[i];
                this._shaders[anchor][a][panelN] =
                  panel.children[0].children[i + 1];
              }
            }
            content.style[metric] = content.style["max" + capitalize(metric)] =
      ...
      return this._iterate(
        ...
        (function(_this) {
          return function(panel, i, len) {
            return _this._setPanelTrans.apply(
              _this,
              [anchor].concat(slice.call(arguments), [duration], [delay])
            );
          };
        })(this)
      );
    ...
    OriDomi.prototype._setPanelTrans = function(
      anchor,
      panel,
      i,
      len,
      ...
      if (this._shading) {
        ref1 =
          indexOf.call(anchorListV, anchor) >= 0 ? anchorListV : anchorListH;
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          side = ref1[j];
    ...
    OriDomi.prototype._showStage = function(anchor) {
      if (anchor !== this._lastOp.anchor) {
        ...
        return (this._stages[anchor].style[css.transform] =
          "translate3d(" +
          function() {
            switch (anchor) {
              case "left":
    ...
    OriDomi.prototype._onTouchStart = function(e) {
      ...
      this._setTrans(0, 0);
      this._touchAxis = ((ref1 = this._lastOp.anchor),
      indexOf.call(anchorListV, ref1) >= 0)
        ? "x"
        : "y";
      ...
      if (e.type === "mousedown") {
        ...
        this[axis1] =
          e.targetTouches[0]["page" + this._touchAxis.toUpperCase()];
      }
    ...
    OriDomi.prototype._onTouchMove = function(e) {
      ...
      distance =
        (current - this["_" + this._touchAxis + "1"]) *
        this._config.touchSensitivity;
      if (this._lastOp.angle < 0) {
        if (
          this._lastOp.anchor === "right" ||
          this._lastOp.anchor === "bottom"
        ) {
    ...
    OriDomi.prototype._onTouchEnd = function(e) {
      ...
      return this._config.touchEndCallback(
        this["_" + this._touchAxis + "Last"],
        e
      );
    };
    ...
    OriDomi.prototype._unfold = function(callback) {
      ...
      return this._iterate(
        ...
        (function(_this) {
          return function(panel, i, len) {
            var delay;
            delay = _this._setPanelTrans.apply(
              _this,
              [anchor].concat(slice.call(arguments), [_this._config.speed], [1])
            );
            return (function(panel, i, delay) {
              return defer(function() {
                ...
                return setTimeout(function() {
                  ...
                  return defer(function() {
                    return (panel.style[css.transitionDuration] =
                      _this._config.speed);
                  });
                }, delay + _this._config.speed * 0.25);
              });
            })(panel, i, delay);
          };
        })(this)
    ...
    OriDomi.prototype.curl = prep(function(angle, anchor, options) {
      angle /=
        indexOf.call(anchorListV, anchor) >= 0
          ? this._config.vPanels.length
          : this._config.hPanels.length;
      return this._iterate(
        anchor,
        (function(_this) {
          return function(panel, i) {
        ...
        (function(_this) {
          return function() {
            ...
            return _this._iterate(anchor, function(panel, i, len) {
              ...
              delay = _this._setPanelTrans.apply(
                _this,
                [anchor].concat(slice.call(arguments), [duration], [2])
              );
              return (function(panel, i, delay) {
                return defer(function() {
